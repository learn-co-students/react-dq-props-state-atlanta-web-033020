...
export default class MasterHog extends Component {
  ...
  mapOffspring = (parent) => offspring.map(child => {
    return <BabyHog key={child.id} name={child.name} hobby={child.hobby} eyeColor={parent.state.eyeColor} />
  })
